...
data = pd.read_excel("data_standard_920.xlsx")
x = data.iloc[:,0:-1]
y = data["target"]
...
print("精确率和召回率为：", classification_report(y_test, estimator.predict(x_test), labels=[0,1,2,3], target_names=['正常','爆破音','哮鸣音','正常音+哮鸣音']))
